...
DATASET_ROOT = os.path.join(PROJECT_ROOT, "dataset", "dataset_rubsheet_3to1")
...
MODEL_SAVE_PATH = os.path.join(PROJECT_ROOT, "models", "rubsheet_3to1_model.pth")
ANALYSIS_DIR = os.path.join(PROJECT_ROOT, "results", "rubsheet_3to1")
LOG_DIR = os.path.join(PROJECT_ROOT, "logs")
LOG_FILE = os.path.join(LOG_DIR, "logs_rubsheet_3to1.log")
