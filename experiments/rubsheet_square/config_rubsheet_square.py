...
DATASET_ROOT = os.path.join(PROJECT_ROOT, "dataset", "dataset_rubsheet_square")
...
MODEL_SAVE_PATH = os.path.join(PROJECT_ROOT, "models", "rubsheet_square_model.pth")
ANALYSIS_DIR = os.path.join(PROJECT_ROOT, "results", "rubsheet_square")
LOG_DIR = os.path.join(PROJECT_ROOT, "logs")
LOG_FILE = os.path.join(LOG_DIR, "logs_rubsheet_square.log")
